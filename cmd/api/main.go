...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "7e281b853b680d", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "52a68a6bd3a0c6", "SMTP password")
	flag.StringVar(
		&cfg.smtp.sender,
		"smtp-sender",
